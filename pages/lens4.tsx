...
const Composer = (props: {rootRef: RefObject<HTMLDivElement>}) => {
  ...
  const displacementShader = {
    uniforms: {
      ...
      "voxelResolution": new THREE.Uniform(new THREE.Vector2(5, 5))
    },
    vertexShader: `
    varying vec2 vUv;
    void main() {
    ...
    void main () {
      ...
      float density = float_per_grid();
      vec3 hsvcolor = rgb2hsv(color.xyz);
      // gl_FragColor = vec4(density * 1., 0, 0, 1);
      hsvcolor.y = hsvcolor.y * (1. - density);
      hsvcolor.z = hsvcolor.z * (1. - density * 0.8);
